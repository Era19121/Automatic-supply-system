...
<div class="login100-form-title">
			...
			<span class="login100-form-title-1">AUTOMATIC ORDER GNERATION</span>
...
<form action="purchase11.jsp" method="post" class="login100-form validate-form">
...
try
{
	...
	PreparedStatement pst=con.prepareStatement("select * from orderdata");
...
String pname = rs.getString("productname");
 seller = rs.getString("sellerid");
Date date = rs.getDate("date");
%>
<option  value="<%=id %>"><%=id %>--<%=pname %>--sold by-<%=seller %>--ordered on-<%=date %></option>
...
<input class="input100" type="hidden" value="<%=seller %>" name="seller"/>
